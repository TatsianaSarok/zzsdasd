const Lsi = {
  appName: {
    cs: "Aplikace uuSweaterweather",
    en: "Application uuSweaterweather",
  },

  left: {
    home: {
      cs: "Vítejte",
      en: "Welcome Crazy team",
    },
    about: {
      cs: "O aplikaci",
  ...
  about: {
    header: {
      cs: "O aplikaci uuSweaterweather",
      en: "About application uuSweaterweather",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuSweaterweather.",
      en: "You can buy your own uuSweaterweather.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuSweaterweather.",
      en: "You don't have rights to initialize this uuSweaterweather.",
    },
  },
