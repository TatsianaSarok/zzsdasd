...
const Errors = require("../api/errors/sweaterweather-main-error.js");
...
const logger = LoggerFactory.get("SweaterweatherMainAbl");

class SweaterweatherMainAbl {
  constructor() {
...
module.exports = new SweaterweatherMainAbl();
